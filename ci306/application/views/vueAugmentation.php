    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="<?php echo base_url('../Landing/profil'); ?>">Profil</a></li>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
        <div class="col-lg-8">
          ...
          <div class="btns">
            <a href="<?php echo base_url('../Wallet'); ?>" class="btn-book animated fadeInUp scrollto">Wallet</a>
          </div>
        </div>
...
<section id="menu" class="menu section-bg">
    <div class="container" data-aos="fade-up">
        ...
        <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
            <?php foreach ($plat as $index => $p): ?>
                <div class="col-lg-6 menu-item filter-starters <?php echo 'menu-item-step'.($index + 1); ?>">
...
<section id="menu" class="menu section-bg">
    <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
            <h2>Sport</h2>
            <p>Check the sport activity here</p>
        </div>
        ...
        <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
            <?php foreach ($sport as $index => $p): ?>
                <div class="col-lg-6 menu-item filter-starters <?php echo 'menu-item-step'.($index + 1); ?>">
                    <img src="<?php echo base_url($p->photoMampitombosport); ?>" class="menu-img" alt="">
                    <div class="menu-content">
                        <a href="#"><?php echo $p->nomMampitombosport; ?></a><span></span>
                    </div>
                    <div class="menu-ingredients">
                        Lorem, deren, trataro, filede, nerada
                    </div>
